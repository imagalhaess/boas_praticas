...
public class AdocaoService {
    ...
    public void reprovar(ReprovacaoAdocaoDto dto){
        Adocao adocao = repository.getReferenceById(dto.idAdocao());
        adocao.solicitacaoReprovada(dto.justificativa());
        ...
        emailService.enviarEmail(adocao.getPet().getAbrigo().getEmail(), "Adoção reprovada.",
                                 "Olá " + adocao.getTutor().getNome() +
                                         ...
                                         adocao.getData().format(DateTimeFormatter.
                                                                         ofPattern("dd/MM/yyyy HH:mm:ss")) +
                                         ", foi reprovada pelo abrigo " + adocao.getPet().
                                         getAbrigo().getNome() + " com a seguinte justificativa: " +
